...
use SergeiK\VladAuto33Bundle\Entity\Client;
use SergeiK\VladAuto33Bundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SergeiKVladAuto33Bundle:Client')->findAll();
     ...
     * @Method("POST")
     * @Template("SergeiKVladAuto33Bundle:Client:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SergeiKVladAuto33Bundle:Client')->find($id);
     ...
     * @Method("PUT")
     * @Template("SergeiKVladAuto33Bundle:Client:edit.html.twig")
     */
