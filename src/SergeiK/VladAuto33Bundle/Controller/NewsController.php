...
use SergeiK\VladAuto33Bundle\Entity\News;
use SergeiK\VladAuto33Bundle\Form\NewsType;
...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SergeiKVladAuto33Bundle:News')->findAll();
     ...
     * @Method("POST")
     * @Template("SergeiKVladAuto33Bundle:News:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SergeiKVladAuto33Bundle:News')->find($id);
     ...
     * @Method("PUT")
     * @Template("SergeiKVladAuto33Bundle:News:edit.html.twig")
     */
