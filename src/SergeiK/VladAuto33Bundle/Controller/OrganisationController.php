...
use SergeiK\VladAuto33Bundle\Entity\Organisation;
use SergeiK\VladAuto33Bundle\Form\OrganisationType;
...
class OrganisationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SergeiKVladAuto33Bundle:Organisation')->findAll();
     ...
     * @Method("POST")
     * @Template("SergeiKVladAuto33Bundle:Organisation:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SergeiKVladAuto33Bundle:Organisation')->find($id);
     ...
     * @Method("PUT")
     * @Template("SergeiKVladAuto33Bundle:Organisation:edit.html.twig")
     */
